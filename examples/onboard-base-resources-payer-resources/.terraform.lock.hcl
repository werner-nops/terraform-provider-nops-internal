...
provider "terraform.local/custom/nops" {
  version     = "1.0.1"
  constraints = "1.0.1"
  hashes = [
    "h1:fgmlTZgZpMpow+K0k4WW5fBpXAK4pVdP+FghlK7S8lQ=",
  ]
}

provider "terraform.local/custom/nops-integration" {
  version     = "1.0.1"
  constraints = "1.0.1"
  hashes = [
    "h1:EFW5cSCeYYCfOxS7+rKdk6eMpQkt+b4aQw1jbukTTAA=",
  ]
}
